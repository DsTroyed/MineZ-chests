...
public class CheckLocation
{
  ...
  public void WorldChecker(Block chest, Player player, Boolean respawn) {
    ...
    if ((!this.pl.chest.containsKey(chest.getLocation())) && 
      (!BlockChecker(player, Integer.valueOf(chest.getLocation().getBlockX()), Integer.valueOf(chest.getLocation().getBlockY()), Integer.valueOf(chest.getLocation().getBlockZ()), chestc))) {
      ...
      for (String s : enabled)
        if ((chest.getLocation().getWorld().getName().equalsIgnoreCase(s)) && 
          (!this.pl.chest.containsKey(chest.getLocation()))){
    ...
    if (!this.pl.si.signChecker(chest.getLocation())) {
      ...
      for (String name : lists) {
        ...
        if ((listworld.equalsIgnoreCase(player.getWorld().getName())) && 
          (x1.equals(x2)) && (y1.equals(y2)) && (z1.equals(z2))) {
